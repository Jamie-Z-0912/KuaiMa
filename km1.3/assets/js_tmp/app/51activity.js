define("app/51activity", [ "../mod/base", "../plugs/tipsAd.js" ], function(require, exports, module) {
    ...
    Ajax.custom({
        ...
        if (d.status == 1e3) {
            ...
            if (data.is_start) {
                ...
                $("#todayStatus").html('<div class="tip">活动未开始，敬请关注</div>').prev().hide();
            }
            $("#desc").text(act.desc);
            ...
            Ajax.custom({
                ...
                if (d.status == 1e3) {
                    new tipsAd({
                        type: "receive",
                        title: "恭喜您获得奖励",
                        text: '<img src="./image/mycard.png" class="rec_img" />' + '<p class="rec_red">' + rew_num + "天阅读加速卡一张</p>" + '<p class="rec_gray">奖励已经发送至您的账户</p>',
                        hasAd: "0",
                        isClose: "no",
                        btnType: "1"
                    });
