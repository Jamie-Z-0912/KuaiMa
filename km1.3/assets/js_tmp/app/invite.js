define("app/invite", [ "../mod/base", "../plugs/tipsAd.js", "../plugs/version.js", "../plugs/swiper-2.7.min.js" ], function(require, exports, module) {
    ...
    function make_qr(uid, channel) {
        var mylink = myurl + "?uid=" + uid + "&channel=" + channel;
        console.log(mylink);
