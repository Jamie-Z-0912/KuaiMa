define("app/sign", [ "../mod/base", "../plugs/popups.js" ], function(require, exports, module) {
    ...
    Ajax.custom({
        ...
        if (data.status == 1e3) {
            ...
            if (r_n > 0) {
                ...
                if (d.today) $days.eq(0).addClass("has_get"); else $days.eq(0).addClass("cur");
            }
            ...
            var tips;
            if (d.sign_num > 2) tips = "恭喜您，已连续签到" + d.sign_num + "天，"; else tips = "已经连续签到" + d.sign_num + "天，";
            if (d.today) {
